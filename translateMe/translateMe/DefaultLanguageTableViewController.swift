//
//  DefaultLanguageTableViewController.swift
//  translateMe
//
//  Created by Wan Kim Mok on 10/22/16.
//  Copyright © 2016 Wan Kim Mok. All rights reserved.
//

import UIKit

class DefaultLanguageTableViewController: UITableViewController {

    let language_list : [String: String]  = [
